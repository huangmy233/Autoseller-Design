...
vlog -vlog01compat -work work +incdir+D:/work/Verilogwork/Seller {D:/work/Verilogwork/Seller/Autoseller.v}

vlog -vlog01compat -work work +incdir+D:/work/Verilogwork/Seller {D:/work/Verilogwork/Seller/Autoseller_tb.v}
vlog -vlog01compat -work work +incdir+D:/work/Verilogwork/Seller {D:/work/Verilogwork/Seller/Autoseller.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  Autoseller_tb
